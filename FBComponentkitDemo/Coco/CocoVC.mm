...
@interface CocoVC ()<CKComponentProvider,UICollectionViewDelegateFlowLayout>

@property(nonatomic,strong) CKCollectionViewDataSource *dataSource;

@end

@implementation CocoVC
...
-(void)goSetup
{
    ...
    CKSizeRange s_range = [sizeRangeProvider sizeRangeForBoundingSize:(CGSize){self.collectionView.bounds.size.width,400}];
    //SizeRangeProvider:用来在调整Size的，类似UIKit中的contentSize
    
    id myClsss = [self class];
    //Configuration:用来告诉DataSource谁来提供component，谁来提供size
    CKDataSourceConfiguration *configuration = [[CKDataSourceConfiguration alloc] initWithComponentProvider:myClsss
                                                                                                    context:nil
                                                                                                sizeRange:s_range];
...
+(CKComponent *)getBstyleLayoutWithModel:(CocoModel*)model
{
 ...
 CKInsetComponent*inset2 =    [CKInsetComponent newWithInsets:{0,0,5,0}component:label2];
    ...
    CKFlexboxComponent*layout =   [CKFlexboxComponent  newWithView:{
                                                                        [UIView class],
                                                                        {
                                                            ...
                                                            size:{}
                                                            style:{ .direction = CKFlexboxDirectionVertical}//垂直
                                                            children:{
                                                                {
                                                                    inset1,
                                                                    .alignSelf = CKFlexboxAlignSelfCenter
    ...
    CKFlexboxComponent*layout2 =   [CKFlexboxComponent  newWithView:{
                                                                        [UIView class],
                                                                        {
